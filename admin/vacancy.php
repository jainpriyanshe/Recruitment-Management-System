			...
			<div class="col-md-12">
				<div class="card">
					<div class="card-header">
						<div class="row">
							<div class="col-lg-12">
								<span><large><b>Requirement List</b></large></span>
								<button class="btn btn-sm btn-block btn-primary btn-sm col-md-2 float-right" type="button" id="new_vacancy"><i class="fa fa-plus"></i> New Requirement</button>
							</div>
						</div>
...
<script>
	...
	$("#new_vacancy").click(function(){
		uni_modal("New Requirement","manage_vacancy.php","mid-large")
	})
	$(".edit_vacancy").click(function(){
		uni_modal("Edit Requirement","manage_vacancy.php?id="+$(this).attr('data-id'),"mid-large")
	})
