...
<?php if(isset($id)): ?>
		...
		<div class="row form-group">
			...
			<div class="col-md-4">
				...
				<input type="date" class="form-control" name="dob" required="" value="<?php echo isset($dob) ? $dob:''  ?>">
						...
						<div class="col-md-4">
				<label for="" class="control-label">Linkedin ID</label>
				<input type="text" class="form-control" name="linkedin" required="" value="<?php echo isset($linkedin) ? $linkedin:''  ?>">
			</div>
		</div>
		<div class="row form-group">	
			<div class="col-md-4">
		...
		<div class="col-md-4">
				...
				<input type="text" class="form-control" name="dp" required="" value="<?php echo isset($dp) ? $dp:''  ?>">
			</div>
		</div>
		<div class="row form-group">
			<div class="col-md-4">
				<label for="" class="control-label">Current CTC</label>
				<input type="text" class="form-control" name="ctc" required="" value="<?php echo isset($ctc) ? $ctc:''  ?>">
			</div>
			<div class="col-md-4">
				<label for="" class="control-label">Fixed CTC</label>
				<input type="text" class="form-control" name="ftc" required="" value="<?php echo isset($ftc) ? $ftc:''  ?>">
			</div>
			<div class="col-md-4">
				<label for="" class="control-label">Expected CTC</label>
				<input type="text" class="form-control" name="etc" required="" value="<?php echo isset($etc) ? $etc:''  ?>">
			</div>
		</div>
		<div class="row form-group">
			<div class="col-md-4">
			...
			<div class="col-md-4">
				...
				<input type="text" class="form-control" name="np" required="" value="<?php echo isset($np) ? $np:''  ?>">
			</div>
			<div class="col-md-4">
				<label for="" class="control-label">Last Working Day</label>
				<input type="date" class="form-control" name="lwd" required="" value="<?php echo isset($lwd) ? $lwd:''  ?>">
			</div>
		</div>
			<div class="row form-group">
			<div class="col-md-4">
				<label for="" class="control-label">Current Location</label>
				<input type="text" class="form-control" name="location" required="" value="<?php echo isset($location) ? $location:''  ?>">
			</div>
			<div class="col-md-4">
