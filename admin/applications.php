				...
				<div class="card">
					<div class="card-header">
						<div class="row">
							<div class="col-lg-12">
								...
								<button class="btn btn-sm btn-block btn-primary btn-sm col-md-2 float-right" type="button" id="new_application"><i class="fa fa-plus"></i> New Candidate</button>
							</div>
						</div>
					...
					<div class="card-body">
						<div class="row">
							<div class="col-lg-12">
								<div class="row">
									<div class="col-md-2 offset-md-2 text-right"></div>
									<div class="col-md-5">
						...
						<table class="table table-bordered table-hover">
							...
							<thead>
								<tr>
									...
									<th class="text-center">Candiate Name</th>
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										<p><?php echo ucwords($row['firstname'].' '.$row['lastname']) ?></p>
									</td>
										<td class="text-center">
										<?php echo $row['dp'] ?>
									</td>
...
<script>
	...
	$("#new_application").click(function(){
		uni_modal("New Candidate","manage_application.php","mid-large")
	})
	$(".edit_application").click(function(){
		uni_modal("Edit Candidate","manage_application.php?id="+$(this).attr('data-id'),"mid-large")
	})
